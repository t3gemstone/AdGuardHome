...
export const MANUAL_UPDATE_LINK = 'https://github.com/t3gemstone/AdGuardHome/wiki/FAQ#manual-update';
export const PORT_53_FAQ_LINK = 'https://github.com/t3gemstone/AdGuardHome/wiki/FAQ#bindinuse';
...
export const UPSTREAM_CONFIGURATION_WIKI_LINK =
    'https://github.com/t3gemstone/AdGuardHome/wiki/Configuration#upstreams';
